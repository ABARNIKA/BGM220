...
#define GC9A01_CS_PORT  gpioPortC   // mikroBUS CS
#define GC9A01_CS_PIN   4
#define GC9A01_DC_PORT  gpioPortD   // mikroBUS PWM
#define GC9A01_DC_PIN   2
#define GC9A01_RST_PORT gpioPortC   // mikroBUS RST
#define GC9A01_RST_PIN  7
#define GC9A01_BL_PORT  gpioPortB   // mikroBUS INT
