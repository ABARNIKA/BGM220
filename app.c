...
void GC9A01_set_chip_select(uint8_t val) {
    val ? GPIO_PinOutSet(gpioPortC, 3) : GPIO_PinOutClear(gpioPortC, 3);
}
void GC9A01_set_data_command(uint8_t val) {
    val ? GPIO_PinOutSet(gpioPortB, 4) : GPIO_PinOutClear(gpioPortB, 4);
}
void GC9A01_set_reset(uint8_t val) {
    val ? GPIO_PinOutSet(gpioPortC, 6) : GPIO_PinOutClear(gpioPortC, 6);
}
